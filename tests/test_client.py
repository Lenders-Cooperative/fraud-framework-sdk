...
@pytest.mark.parametrize(
    ...
    [
        (
            "client",
            {"token": 12345, "request_id": "1231312314124214", "has_json": True},
            ["Authorization", "Content-Type", "User-Agent", "x-request-id"],
        ),
        (
            "client",
            {"token": 12345, "request_id": "1231312314124214", "source_program": "TEST", "has_json": True},
            [
                "Authorization",
                "Content-Type",
                "User-Agent",
        ...
        (
            "client",
            {"token": 12345, "request_id": "1231312314124214", "source_app": "123123123123", "has_json": True},
            [
                "Authorization",
                "Content-Type",
                "User-Agent",
        ...
        (
            "client",
            {"token": 12345, "request_id": "1231312314124214", "source_app": None, "has_json": True},
            [
                "Authorization",
                "Content-Type",
                "User-Agent",
